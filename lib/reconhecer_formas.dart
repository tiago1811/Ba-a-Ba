...
class ReconhecerFormas extends StatefulWidget {
  ...
  @override
  State<ReconhecerFormas> createState() => _ReconhecerFormas2State();
}

class _ReconhecerFormas2State extends State<ReconhecerFormas> {
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Image.asset(
              'assets/formas1/$imagemAleatoria',
